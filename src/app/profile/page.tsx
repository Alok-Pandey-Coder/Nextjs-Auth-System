...
export default function ProfilePage() {
  ...
  return (
    <div className="flex flex-col items-center jusrify-center min-h-screen py-2">
      <h1>Profile</h1>
      <hr />
      <p>Profile page</p>
      ...
      <button onClick={getUserDetails} className="bg-green-500 mt-4 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Get user details</button>
    </div>
  )
}